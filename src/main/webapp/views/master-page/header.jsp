...
<div class="header">
	<div class="container">
		<div class="logo">
			<h1>
				<a href="welcome.do">DELIBERATIONS </a>
			</h1>
		</div>
		...
		<div class="ad-ph">
			...
			<p>AGORA US</p>
			<span><a href="?language=en">en</a> | <a href="?language=es">es</a></span>
			<br>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<security:authorize access="isAnonymous()">
						<li><a href="user/login.do"> <span
								class="glyphicon glyphicon-log-in " aria-hidden="true"></span> <spring:message
